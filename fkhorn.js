...
new cron.CronJob('00 * * * * *', () => {
  ...
  getGamesEurope().then(games => {
    ...
    } else bot.channels.fetch("1219989241782599801").then(chan => chan.send(`:flag_eu: \`${date_eu}\` : no hit for **Inazuma Eleven** on the **European eShop**`))
  })
