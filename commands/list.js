...
module.exports.run = async (bot, message, args) => {
  ...
  if(args == "safe"){
    ...
    str_snd += "------------------------------------\n"
    str_snd += "These commands can be used anytime\n"
    str_snd += "```"
    message.channel.send('Airhorn safe sound list ('+(bot.sound_collections.length-bot.not_safe.list.length)+') : \n'+str_snd)
    ...
    str_snd += "```"
    message.channel.send('Airhorn not safe sound list ('+bot.not_safe.list.length+') : \n'+str_snd)
